 ...
 * {@link #checkInterfacesListAndStart()} to mark that the part is fully initialized and implementation code should
...
public interface ConstructorPart {
     ...
     * <p>
     * Subsequent calls should return the same set of objects until {@link #checkInterfacesListAndStart()} method would
     * be called.
     */
    ...
    /**
     * Marks the part to be fully linked to the rest of an application. Framework guarantees at this point that each
     ...
     * part object.
     */
    void checkInterfacesListAndStart();
}
